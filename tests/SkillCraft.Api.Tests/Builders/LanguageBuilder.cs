...
public interface ILanguageBuilder
{
  ...
  ILanguageBuilder WithScript(ScriptId? scriptId);
...
public class LanguageBuilder : ILanguageBuilder
{
  ...
  public ILanguageBuilder WithScript(ScriptId? scriptId)
  {
    _scriptId = scriptId;
    return this;
  }
  ...
  public Language Build()
  {
    ...
    language.SetRules(TypicalSpeakers.TryCreate(_typicalSpeakers), _scriptId, actorId);

    return language;
  }

  public static Language Common(Faker? faker = null, World? world = null, ScriptId? scriptId = null) => new LanguageBuilder(faker)
    .WithWorld(world)
    .WithName("Commun")
  ...
  public static Language Celfique(Faker? faker = null, World? world = null, ScriptId? scriptId = null) => new LanguageBuilder(faker)
    .WithWorld(world)
    .WithName("Celfique")
