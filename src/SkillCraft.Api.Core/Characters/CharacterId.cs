...
public readonly struct CharacterId
{
  ...
  public CharacterId(WorldId worldId, Guid resourceId)
  {
    ResourceIdentifier resource = new(Character.ResourceKind, resourceId, worldId);
  ...
  public static CharacterId NewId(WorldId worldId) => new(worldId, Guid.NewGuid());
