...
namespace SkillCraft.Api.PostgreSQL.Migrations
{
    ...
    [Migration("20260802163024_LineageEventSourcing")]
    partial class LineageEventSourcing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SkillCraft.Api.Infrastructure.Entities.LanguageEntity", b =>
                {
                    ...
                    b.Property<int?>("LineageEntityLineageId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LineageEntityLineageId");
            ...
            modelBuilder.Entity("SkillCraft.Api.Infrastructure.Entities.LanguageEntity", b =>
                {
                    b.HasOne("SkillCraft.Api.Infrastructure.Entities.LineageEntity", null)
                        .WithMany("Languages")
                        .HasForeignKey("LineageEntityLineageId");
