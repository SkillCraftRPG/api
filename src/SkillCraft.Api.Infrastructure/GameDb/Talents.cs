...
{
  public static readonly TableId Table = new(GameContext.Schema, nameof(GameContext.Talents), alias: null);
  ...
  public static readonly ColumnId WorldUid = new(nameof(TalentEntity.WorldUid), Table);
}
